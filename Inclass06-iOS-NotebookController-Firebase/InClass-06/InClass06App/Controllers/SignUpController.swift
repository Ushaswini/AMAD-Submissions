            ...
            Auth.auth().createUser(withEmail: (EmailTf?.text)!, password: PasswordTf.text!){ (user, error) in
                ...
                if error == nil {
                    ...
                    if let userId = user?.uid{
                        ...
                        let userObj = User(id:userId,userName:(self.NameTf?.text)!,userNoteBooks:Array<NoteBook>())
                    ...
                    let newViewController = storyBoard.instantiateViewController(withIdentifier: "NavForNoteBooksController") as! UINavigationController
